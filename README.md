...
| case_transform   | Optional transformation applied to the column value during sync. Accepts `upper`, `lower`, or `null_if_empty`.                          | (string) | _upper_ \| _lower_ \| _null_if_empty_                                                          |
...
> | `null_if_empty` | Converts empty strings to `null`                        |
>
